...
// Get the current page to identify the active link
$current_page = basename($_SERVER['PHP_SELF']);

// Determine if the user is logged in
$is_logged_in = isset($_SESSION['user_name']) || isset($_SESSION['admin_name']);

// Set the username for display in the dropdown
$username = $is_logged_in ? ($_SESSION['user_name'] ?? $_SESSION['admin_name']) : 'Login';
?>
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          ...
          <h1 class="mb-0 bread">Pet-sitting</h1>
        </div>
      </div>
    </div>
  </section>
...
<div class="container mt-5">
    ...
    <p>Please fill in the form below to request pet sitting services.</p>
    <form action="about.php" method="POST">
        ...
        <div class="form-group">
            <label for="pet_name">Pet Name(s)</label>
            <input type="text" class="form-control" id="pet_name" name="pet_name" required>
        </div>
        <div class="form-group">
            <label for="pet_type">Pet Type (optional)</label>
...
$servername = "localhost:3308"; // Modify if necessary
$username = "root";
$password = "";
$dbname = "CP";
...
$sql = "INSERT INTO Sitting (user_name, email, phone, pet_name, pet_type, start_date, end_date, notes) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
...
// Execute the query
if ($stmt->execute()) {
    echo "Pet sitting request has been submitted successfully!";
} else {
